# perbandingan-nginx-load-balance-round-robin-dan-least-connection  
...
Pengujian dilakukan menggunakan beberapa skenario beban dan benchmark menggunakan :contentReference[oaicite:2]{index=2}.
